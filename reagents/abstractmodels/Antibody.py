...
class AbstractAntibody(models.Model):
	...
	antibody_name = models.CharField("Name", max_length=50, help_text="""(p.e. "anti-Something")""")
	...
	antibody_reactivity = models.CharField("Reactivity", max_length=50, help_text="""(species the Ab is know to react to)""")
	...
	lab = models.ForeignKey("Lab", verbose_name="Lab", default=True)
